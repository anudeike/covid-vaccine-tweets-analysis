...
def main():
    ...
    path_to_clean = "reduced/2020-07_2020-09_reduced_4800000_to_5500000_full.csv"
    ...
    df.to_csv("preprocessed/2020-07_2020-09_preproccessed_4800000_to_5500000_full.csv", index=False)
