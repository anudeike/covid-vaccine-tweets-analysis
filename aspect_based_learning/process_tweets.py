...
def main():
    ...
    path_to_clean = "reduced/2020-07_2020-09_reduced_2500000_to_3000000_full.csv"
    ...
    df.to_csv("preprocessed/2020-07_2020-09_preproccessed_2500000_to_3000000_full.csv", index=False)
